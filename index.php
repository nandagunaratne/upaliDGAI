...
<section id="hero">
	<div id="heroCarousel" class="carousel slide carousel-fade"
		...
		<a class="carousel-control-prev" href="#heroCarousel" role="button"
			...
			class="carousel-control-prev-icon bx bx-left-arrow"
			aria-hidden="true"></span> <span class="sr-only">Previous</span>
		</a> <a class="carousel-control-next" href="#heroCarousel"
			role="button" data-slide="next"> <span
			class="carousel-control-next-icon bx bx-right-arrow"
...
celebrated name in both traditional and contempo- rary dance.
			...
			<div class="text-top col-lg-3 text-right text-lg-right">
				<div class="col-lg-3  text-center">
					<a class="cta-btn align-middle" target="_blank"
						href="assets/pdf/iso.pdf"><img
						src="assets/img/ISO_9001_Quality_MONO.jpg" width="250"></a>
				</div>
			</div>
		</div>
	</div>
...
<!-- Start Temporary for XMas Section -- Also need to enable the script on bottom of page-->
<!-- 
<div id="simpleModal" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Merry Christmas and Happy New Year</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <iframe src="assets/img/Merry Christmas and Happy New Year 2023.png" width="750" height="850"frameborder = "0" ></iframe>
            </div>
 ...
 -->
<!-- End Temporary for XMas Section -->
